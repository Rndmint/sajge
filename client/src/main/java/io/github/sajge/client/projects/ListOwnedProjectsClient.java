...
public class ListOwnedProjectsClient
        extends BaseClient<
                ListOwnedProjectsClient.SuccessResponse,
                ListOwnedProjectsClient.ErrorResponse> {

    private static final String REQUEST_TYPE = "LIST_OWNED_PROJECTS";
    private static final String SUCCESS_TYPE = "LIST_OWNED_PROJECTS_RESULT";
