...
public class CreateProjectClient
        extends BaseClient<CreateProjectClient.SuccessResponse, CreateProjectClient.ErrorResponse> {

    private static final String REQUEST_TYPE = "CREATE_PROJECT";
    private static final String SUCCESS_TYPE = "CREATE_PROJECT_RESULT";
    ...
    public void send(String token,
        ...
        Request req = new Request(new Payload(token, name, description, sceneJson));
