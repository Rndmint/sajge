...
public class DeleteAccountClient
        extends BaseClient<
                DeleteAccountClient.SuccessResponse,
                DeleteAccountClient.ErrorResponse> {

    private static final String REQUEST_TYPE  = "DELETE_ACCOUNT";
    private static final String SUCCESS_TYPE  = "DELETE_ACCOUNT_RESULT";
    ...
    public void send(String username, String token) throws Exception {
        Request req = new Request(new Payload(username, token));
