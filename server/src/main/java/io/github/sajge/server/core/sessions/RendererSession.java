...
public class RendererSession extends ServiceSupport {
    @Override
    public boolean canProcess(Request request) {
        return request.isAuthenticated() && "RENDER".equalsIgnoreCase(request.getPayload());
    }

    @Override
    public Response process(Request request) {
        return new Response("Rendered frame");
    }
}
